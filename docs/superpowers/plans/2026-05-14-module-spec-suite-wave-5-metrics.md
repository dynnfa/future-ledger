# FutureLedger Module Spec Suite Wave 5: Metrics Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create the metrics spec for dividend yield and trailing one-year return calculations.

**Architecture:** Wave 5 is serial and contains only Task 8. It should wait for Wave 4 so metric assumptions, missing-input flags, and price/dividend contracts match the normalization specs.
...
Run this task after Wave 4 has completed and normalization specs are committed.
